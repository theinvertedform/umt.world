...
description: Inspiration, theorization, technical implementation, and future projections. 
abstract: This website is both a literary project, and a visual project. My inspirations as a writer are discussed, along with theories of the avant-garde, outsider art, digital culture, and the social function of art criticism. New media and hypermedia are discussed, before the technical details of the website and the idealized form of the knowledge management architecture are described in detail.
layout: meta
toc: true
tags:
  - outsider art
